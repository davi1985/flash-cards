...
import { ProgressCircle } from '../components/progess-circle'
      ...
      <main className="p-6 flex flex-col gap-4">
        ...
        <div className="flex flex-col gap-5 py-6 px-5 rounded-lg border border-mirage-100 bg-mirage-50 shadow-lg">
          ...
          <div className="flex items-center justify-between">
            <a
              href="#"
              className="py-3 px-5 flex items-center gap-3 font-bold text-sm bg-marine-500 rounded-md text-marine-50"
            >
              Acessar coleção
